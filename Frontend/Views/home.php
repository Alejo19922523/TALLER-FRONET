...
<html>
  <head>
    ...
    <link rel="icon" href="<?= media(); ?>images/uploads/icono.ico">
    <title>Login</title>
  </head>
  <body>
  <nav class="navbar navbar-expand-md navbar-light bg-faded">
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" action="index.html">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>Inicar Sesión</h3>
          <div class="form-group">
            <label class="control-label">Usuario</label>
            <input class="form-control" type="text" placeholder="Usuario o email" autofocus required>
          </div>
          <div class="form-group">
    ...
    <img src="<?= media(); ?>images/uploads/aviso.jpg" alt="Logo" style="width: 150px;">
</div>
